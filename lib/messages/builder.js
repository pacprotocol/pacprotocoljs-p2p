...
function builder(options) {
  ...
  if (!options.network) {
    options.network = pacprotocol.Networks.defaultNetwork;
  }

  options.Block = options.Block || pacprotocol.Block;
  options.BlockHeader = options.BlockHeader || pacprotocol.BlockHeader;
  options.Transaction = options.Transaction || pacprotocol.Transaction;
  options.MerkleBlock = options.MerkleBlock || pacprotocol.MerkleBlock;
  options.MnListDiff = options.MnListDiff || pacprotocol.MnListDiff;
  options.protocolVersion = options.protocolVersion || 70221;
